...
export const ModuleContributors: React.FC = () => {
	...
	const maxContribution =
		sortedContributors.length > 0 ? sortedContributors[0].contribution : 0;
				...
				<div className="container mx-auto px-0">
					...
					>
						...
						<p className="text-muted-foreground max-w-2xl mx-auto">
							Celebrating the incredible individuals who drive our project
							forward
						</p>
					</motion.div>
											...
											<div className="w-32">
												<div className="flex justify-start items-center gap-x-2">
													...
													>
														...
														<div className="font-bold w-20 truncate">
															{contributor.name}
														</div>
													</Link>
												</div>
